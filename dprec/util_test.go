...
var _ = Describe("Util", func() {
	...
	Specify("Cos", func() {
		Expect(Cos(0.0)).To(EqualFloat64(1.0))
		Expect(Cos(Pi / 3)).To(EqualFloat64(0.5))
		Expect(Cos(Pi / 2)).To(EqualFloat64(0.0))
	})

	Specify("Sin", func() {
		Expect(Sin(0.0)).To(EqualFloat64(0.0))
		Expect(Sin(Pi / 6)).To(EqualFloat64(0.5))
		Expect(Sin(Pi / 2)).To(EqualFloat64(1.0))
	})
