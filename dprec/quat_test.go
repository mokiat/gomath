...
var _ = Describe("QuatTest", func() {
	...
	DescribeTable("#IsNaN",
		...
		Entry("X is +inf", NewQuat(math.Inf(1), 2.0, 3.0, 4.0), false),
		Entry("Y is +inf", NewQuat(1.0, math.Inf(1), 3.0, 4.0), false),
		Entry("Z is +inf", NewQuat(1.0, 2.0, math.Inf(1), 4.0), false),
		Entry("W is +inf", NewQuat(1.0, 2.0, 3.0, math.Inf(1)), false),
		Entry("X is -inf", NewQuat(math.Inf(-1), 2.0, 3.0, 4.0), false),
		Entry("Y is -inf", NewQuat(1.0, math.Inf(-1), 3.0, 4.0), false),
		Entry("Z is -inf", NewQuat(1.0, 2.0, math.Inf(-1), 4.0), false),
		Entry("W is -inf", NewQuat(1.0, 2.0, 3.0, math.Inf(-1)), false),
		Entry("X is NaN", NewQuat(math.NaN(), 2.0, 3.0, 4.0), true),
		Entry("Y is NaN", NewQuat(1.0, math.NaN(), 3.0, 4.0), true),
		Entry("Z is NaN", NewQuat(1.0, 2.0, math.NaN(), 4.0), true),
		Entry("W is NaN", NewQuat(1.0, 2.0, 3.0, math.NaN()), true),
	)
	...
	DescribeTable("#IsInf",
		...
		Entry("standard floats", NewQuat(1.0, 2.0, 3.0, 4.0), false),
		Entry("X is +inf", NewQuat(math.Inf(1), 2.0, 3.0, 4.0), true),
		Entry("Y is +inf", NewQuat(1.0, math.Inf(1), 3.0, 4.0), true),
		Entry("Z is +inf", NewQuat(1.0, 2.0, math.Inf(1), 4.0), true),
		Entry("W is +inf", NewQuat(1.0, 2.0, 3.0, math.Inf(1)), true),
		Entry("X is -inf", NewQuat(math.Inf(-1), 2.0, 3.0, 4.0), true),
		Entry("Y is -inf", NewQuat(1.0, math.Inf(-1), 3.0, 4.0), true),
		Entry("Z is -inf", NewQuat(1.0, 2.0, math.Inf(-1), 4.0), true),
		Entry("W is -inf", NewQuat(1.0, 2.0, 3.0, math.Inf(-1)), true),
		Entry("X is NaN", NewQuat(math.NaN(), 2.0, 3.0, 4.0), false),
		Entry("Y is NaN", NewQuat(1.0, math.NaN(), 3.0, 4.0), false),
		Entry("Z is NaN", NewQuat(1.0, 2.0, math.NaN(), 4.0), false),
		Entry("W is NaN", NewQuat(1.0, 2.0, 3.0, math.NaN()), false),
	)
	...
	Specify("#Norm", func() {
		norm := quat.Norm()
		Expect(norm).To(EqualFloat64(7.539230729988))
	})
